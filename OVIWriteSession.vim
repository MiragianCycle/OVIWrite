...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 65 + 118) / 237)
exe 'vert 2resize ' . ((&columns * 64 + 118) / 237)
argglobal
balt README.md
setlocal fdm=manual
setlocal fde=0
...
silent! normal! zE
let &fdl = &fdl
let s:l = 203 - ((27 * winheight(0) + 32) / 64)
...
badd +203 ~/Documents/coding\ work/git\ hub\ clones/OVIWrite/.vimrc
