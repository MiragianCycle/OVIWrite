...
"This next section deals with initialization of Vim-plug. Please don't modify it. Much thanks and credit to the person whose dotfiles I borrowed this fromMuch thanks and credit to the person whose dotfiles I borrowed this from. I've left the person's comments unaltered. 
"
...
"Now that we've added the base plugins needed, we can go about adding Vim-Workspace, which allows us to save our working files as one session. 
